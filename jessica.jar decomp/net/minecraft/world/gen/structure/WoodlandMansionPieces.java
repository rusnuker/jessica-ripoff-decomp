...
public class WoodlandMansionPieces {
    ...
    static class Grid {
        ...
        private boolean func_191111_a(SimpleGrid p_191111_1_) {
            boolean flag = false;
            int i = 0;
            while (i < p_191111_1_.field_191150_c) {
                int j = 0;
                while (j < p_191111_1_.field_191149_b) {
                    if (p_191111_1_.func_191145_a(j, i) == 0) {
                        ...
                        if ((k += Grid.func_191109_a(p_191111_1_, j, i - 1) ? 1 : 0) >= 3) {
                            ...
                            l += Grid.func_191109_a(p_191111_1_, j - 1, i + 1) ? 1 : 0;
                            l += Grid.func_191109_a(p_191111_1_, j + 1, i - 1) ? 1 : 0;
                            if ((l += Grid.func_191109_a(p_191111_1_, j - 1, i - 1) ? 1 : 0) <= 1) {
                                p_191111_1_.func_191144_a(j, i, 2);
                                flag = true;
                            }
                        }
        ...
        private void func_191115_b() {
            ...
            int i = 0;
            while (i < this.field_191119_c.field_191150_c) {
                int j = 0;
                while (j < this.field_191119_c.field_191149_b) {
            ...
            if (list.isEmpty()) {
                ...
                int j1 = 0;
                while (j1 < this.field_191119_c.field_191150_c) {
                    int k1 = 0;
                    while (k1 < this.field_191119_c.field_191149_b) {
        ...
        private void func_191116_a(SimpleGrid p_191116_1_, SimpleGrid p_191116_2_) {
            ArrayList list = Lists.newArrayList();
            int i = 0;
            while (i < p_191116_1_.field_191150_c) {
                int j = 0;
                while (j < p_191116_1_.field_191149_b) {
    ...
    static class Placer {
        ...
        public void func_191125_a(BlockPos p_191125_1_, Rotation p_191125_2_, List<MansionTemplate> p_191125_3_, Grid p_191125_4_) {
            ...
            boolean flag = false;
            int k = 0;
            while (k < woodlandmansionpieces$simplegrid1.field_191150_c && !flag) {
                int l = woodlandmansionpieces$simplegrid1.field_191149_b - 1;
                while (l >= 0 && !flag) {
                    if (Grid.func_191109_a(woodlandmansionpieces$simplegrid1, l, k)) {
            ...
            while (l2 < 3) {
                ...
                int i1 = 0;
                while (i1 < woodlandmansionpieces$simplegrid3.field_191150_c) {
                    int j1 = 0;
                    while (j1 < woodlandmansionpieces$simplegrid3.field_191149_b) {
                ...
                ArrayList list = Lists.newArrayList();
                int k1 = 0;
                while (k1 < woodlandmansionpieces$simplegrid3.field_191150_c) {
                    int l1 = 0;
                    while (l1 < woodlandmansionpieces$simplegrid3.field_191149_b) {
                        boolean flag1;
        ...
        private void func_191123_a(List<MansionTemplate> p_191123_1_, BlockPos p_191123_2_, Rotation p_191123_3_, SimpleGrid p_191123_4_, @Nullable SimpleGrid p_191123_5_) {
            int i = 0;
            while (i < p_191123_4_.field_191150_c) {
                int j = 0;
                while (j < p_191123_4_.field_191149_b) {
                    boolean flag;
            ...
            if (p_191123_5_ != null) {
                int k = 0;
                while (k < p_191123_4_.field_191150_c) {
                    int i1 = 0;
                    while (i1 < p_191123_4_.field_191149_b) {
                        ...
                        if (Grid.func_191109_a(p_191123_4_, i1, k) && flag1) {
            ...
            int l = 0;
            while (l < p_191123_4_.field_191150_c) {
                int j1 = 0;
                while (j1 < p_191123_4_.field_191149_b) {
                    boolean flag2;
                    ...
                    if (Grid.func_191109_a(p_191123_4_, j1, l) && !flag2) {
