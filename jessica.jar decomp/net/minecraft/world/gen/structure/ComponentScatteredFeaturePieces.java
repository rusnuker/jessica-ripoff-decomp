...
public class ComponentScatteredFeaturePieces {
    ...
    extends Feature {
        ...
        public boolean addComponentParts(World worldIn, Random randomIn, StructureBoundingBox structureBoundingBoxIn) {
            ...
            int i2 = 0;
            while (i2 < this.scatteredFeatureSizeX) {
                int j = 0;
            ...
            int j2 = 0;
            while (j2 <= this.scatteredFeatureSizeX - 1) {
                ...
                j2 += this.scatteredFeatureSizeX - 1;
            }
            int k2 = 2;
            while (k2 <= this.scatteredFeatureSizeX - 3) {
                ...
                this.setBlockState(worldIn, Blocks.SANDSTONE.getStateFromMeta(BlockSandStone.EnumType.SMOOTH.getMetadata()), k2 + 1, 8, 0, structureBoundingBoxIn);
                k2 += this.scatteredFeatureSizeX - 3 - 2;
            }
