...
public class Explosion {
    ...
    public void doExplosionA() {
        ...
        while (k2 < list.size()) {
            ...
            if (!entity.isImmuneToExplosions() && (d12 = entity.getDistance(this.explosionX, this.explosionY, this.explosionZ) / (double)f3) <= 1.0 && (d13 = (double)MathHelper.sqrt((d5 = entity.posX - this.explosionX) * d5 + (d7 = entity.posY + (double)entity.getEyeHeight() - this.explosionY) * d7 + (d9 = entity.posZ - this.explosionZ) * d9)) != 0.0) {
                ...
                if (!(!(entity instanceof EntityPlayer) || (entityplayer = (EntityPlayer)entity).isSpectator() || entityplayer.isCreative() && entityplayer.capabilities.isFlying)) {
