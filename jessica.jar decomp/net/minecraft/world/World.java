...
implements IBlockAccess {
    ...
    protected void onEntityAdded(Entity entityIn) {
        ...
        try {
            EntityPlayer e;
            if (entityIn instanceof EntityPlayer && Wrapper.getModule("Killaura").isToggled() && !((e = (EntityPlayer)entityIn) instanceof EntityPlayerSP) && !e.isDead && !e.isInvisible() && Wrapper.player().getDistanceToEntity(e) >= 16.0f && !Killaura18_One_Million_Dollars.PlayerAuraAAC.contains(e)) {
                Killaura18_One_Million_Dollars.PlayerAuraAAC.add(e);
            }
        }
        ...
        while (l3 < k2) {
            ...
            while (i4 < i3) {
                ...
                while (j4 < k3) {
                    ...
                    if (iblockstate1.getMaterial() == materialIn && (double)i3 >= (d0 = (double)((float)(i4 + 1) - BlockLiquid.getLiquidHeightPercent(iblockstate1.getValue(BlockLiquid.LEVEL))))) {
                        flag = true;
    ...
    public EntityPlayer func_190525_a(double p_190525_1_, double p_190525_3_, double p_190525_5_, double p_190525_7_, Predicate<Entity> p_190525_9_) {
        ...
        int j2 = 0;
        while (j2 < this.playerEntities.size()) {
    ...
    public void playBroadcastSound(int id, BlockPos pos, int data) {
        int j2 = 0;
        while (j2 < this.eventListeners.size()) {
