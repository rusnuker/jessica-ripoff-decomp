...
extends TileEntity {
    ...
    public boolean executeCommand(final EntityPlayer playerIn) {
        ...
        ITextComponent[] iTextComponentArray = this.signText;
        int n = this.signText.length;
        int n2 = 0;
        while (n2 < n) {
            ClickEvent clickevent;
            Style style;
            ITextComponent itextcomponent = iTextComponentArray[n2];
            Style style2 = style = itextcomponent == null ? null : itextcomponent.getStyle();
            if (style != null && style.getClickEvent() != null && (clickevent = style.getClickEvent()).getAction() == ClickEvent.Action.RUN_COMMAND) {
