...
extends TileEntity {
    ...
    public void setName(String nameIn) {
        String s = nameIn;
        char[] cArray = ChatAllowedCharacters.ILLEGAL_STRUCTURE_CHARACTERS;
        int n = ChatAllowedCharacters.ILLEGAL_STRUCTURE_CHARACTERS.length;
        int n2 = 0;
        while (n2 < n) {
            char c0 = cArray[n2];
            s = s.replace(c0, '_');
    ...
    public static enum Mode implements IStringSerializable
    {
        ...
        static {
            ...
            while (n2 < n) {
                ...
                Mode.MODES[tileentitystructure$mode.getModeId()] = tileentitystructure$mode = modeArray[n2];
                ++n2;
            }
        }
