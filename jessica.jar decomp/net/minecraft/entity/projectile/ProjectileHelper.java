    ...
    public static RayTraceResult forwardsRaycast(Entity p_188802_0_, boolean includeEntities, boolean p_188802_2_, Entity excludedEntity) {
        ...
        if (includeEntities) {
            ...
            while (i < list.size()) {
                ...
                if (!(!entity1.canBeCollidedWith() || !p_188802_2_ && entity1.isEntityEqual(excludedEntity) || entity1.noClip || (raytraceresult1 = (axisalignedbb = entity1.getEntityBoundingBox().expandXyz(0.3f)).calculateIntercept(vec3d, vec3d1)) == null || !((d7 = vec3d.squareDistanceTo(raytraceresult1.hitVec)) < d6) && d6 != 0.0)) {
                    entity = entity1;
                    d6 = d7;
                }
                ++i;
