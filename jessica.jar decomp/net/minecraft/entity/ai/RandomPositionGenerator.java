    ...
    private static Vec3d func_191379_a(EntityCreature p_191379_0_, int p_191379_1_, int p_191379_2_, @Nullable Vec3d p_191379_3_, boolean p_191379_4_) {
        ...
        while (k < 10) {
            ...
            if (p_191379_3_ == null || (double)l * p_191379_3_.xCoord + (double)j1 * p_191379_3_.zCoord >= 0.0) {
                ...
                if ((!flag || p_191379_0_.isWithinHomeDistanceFromPosition(blockpos1)) && pathnavigate.canEntityStandOnPos(blockpos1) && (p_191379_4_ || !RandomPositionGenerator.func_191380_b(blockpos1 = RandomPositionGenerator.func_191378_a(blockpos1, p_191379_0_), p_191379_0_)) && (f1 = p_191379_0_.getBlockPathWeight(blockpos1)) > f) {
                    f = f1;
                    k1 = l;
                    i = i1;
                    j = j1;
