...
extends Entity {
    ...
    protected void entityInit() {
        ...
        DataParameter<Boolean>[] dataParameterArray = DATA_ID_PADDLE;
        int n = DATA_ID_PADDLE.length;
        int n2 = 0;
        while (n2 < n) {
            DataParameter<Boolean> dataparameter = dataParameterArray[n2];
    ...
    public static enum Type {
        ...
        public static Type getTypeFromString(String nameIn) {
            ...
            while (i < Type.values().length) {
                if (Type.values()[i].getName().equals(nameIn)) {
