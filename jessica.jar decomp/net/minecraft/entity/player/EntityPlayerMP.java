...
implements IContainerListener {
    ...
    public void onUpdateEntity() {
        try {
            ...
            while (i < this.inventory.getSizeInventory()) {
                ...
                if (!itemstack.func_190926_b() && itemstack.getItem().isMap() && (packet = ((ItemMapBase)itemstack.getItem()).createMapDataPacket(itemstack, this.world, this)) != null) {
    ...
    public void func_193102_a(ResourceLocation[] p_193102_1_) {
        ...
        ResourceLocation[] resourceLocationArray = p_193102_1_;
        int n = p_193102_1_.length;
        int n2 = 0;
        while (n2 < n) {
