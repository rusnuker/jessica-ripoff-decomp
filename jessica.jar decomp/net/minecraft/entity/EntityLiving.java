...
extends EntityLivingBase {
    ...
    public void faceEntity(Entity entityIn, float maxYawIncrease, float maxPitchIncrease) {
        ...
        this.rotationPitch = EntityLiving.updateRotation(this.rotationPitch, f1, maxPitchIncrease);
        this.rotationYaw = EntityLiving.updateRotation(this.rotationYaw, f, maxYawIncrease);
    }
