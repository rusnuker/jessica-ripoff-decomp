...
implements DebugRenderer.IDebugRenderer {
    ...
    public void render(float p_190060_1_, long p_190060_2_) {
        if (!this.pathMap.isEmpty()) {
            ...
            for (Integer integer : this.pathMap.keySet()) {
                ...
                int j = 0;
                while (j < path.getCurrentPathLength()) {
            ...
            for (Integer integer1 : this.pathMap.keySet()) {
                ...
                PathPoint[] pathPointArray = path1.getClosedSet();
                int n = pathPointArray.length;
                int pathpoint = 0;
                while (pathpoint < n) {
                    PathPoint pathpoint3 = pathPointArray[pathpoint];
                ...
                pathPointArray = path1.getOpenSet();
                n = pathPointArray.length;
                pathpoint = 0;
                while (pathpoint < n) {
                    PathPoint pathpoint4 = pathPointArray[pathpoint];
                ...
                int k = 0;
                while (k < path1.getCurrentPathLength()) {
            ...
            int n2 = 0;
            while (n2 < n) {
                Integer integer2 = integerArray[n2];
    ...
    public void renderPathLine(float p_190067_1_, Path p_190067_2_) {
        ...
        int i = 0;
        while (i < p_190067_2_.getCurrentPathLength()) {
