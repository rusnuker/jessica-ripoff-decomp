...
implements DebugRenderer.IDebugRenderer {
    ...
    public void render(float p_190060_1_, long p_190060_2_) {
        ...
        for (BlockPos blockpos2 : BlockPos.getAllInBox(blockpos.add(-10, -10, -10), blockpos.add(10, 10, 10))) {
            ...
            DebugRenderer.renderDebugText(String.valueOf(s) + " " + integer, (double)blockpos2.getX() + 0.5, (double)blockpos2.getY() + d1, (double)blockpos2.getZ() + 0.5, p_190060_1_, -16777216);
        }
