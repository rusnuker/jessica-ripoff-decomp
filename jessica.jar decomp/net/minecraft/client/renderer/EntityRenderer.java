...
implements IResourceManagerReloadListener {
    ...
    public void getMouseOver(float partialTicks) {
        ...
        if (entity != null && this.mc.world != null) {
            ...
            Vec3d vec3d1 = Killaura18_One_Million_Dollars.timerTrue ? Wrapper.player().getVectorForRotation(Wrapper.player().rotationPitch2, Wrapper.player().rotationYaw2) : entity.getLook(1.0f);
        ...
        if (entity instanceof EntityLivingBase && ((EntityLivingBase)entity).isPlayerSleeping()) {
            ...
            if (this.mc.gameSettings.debugCamEnable) {
                ...
                while (i < 8) {
                    ...
                    float f4 = (i >> 1 & 1) * 2 - 1;
                    float f5 = (i >> 2 & 1) * 2 - 1;
                    if ((raytraceresult = this.mc.world.rayTraceBlocks(new Vec3d(d0 + (double)(f3 *= 0.1f), d1 + (double)(f4 *= 0.1f), d2 + (double)(f5 *= 0.1f)), new Vec3d(d0 - d4 + (double)f3 + (double)f5, d1 - d6 + (double)f4, d2 - d5 + (double)f5))) != null && (d7 = raytraceresult.hitVec.distanceTo(new Vec3d(d0, d1, d2))) < d3) {
                        d3 = d7;
                    }
                    ++i;
                }
