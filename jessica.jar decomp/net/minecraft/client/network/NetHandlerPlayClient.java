...
implements INetHandlerPlayClient {
    ...
    public void handleEntityVelocity(SPacketEntityVelocity packetIn) {
        ...
        if (entity != null && !Wrapper.getModule("AntiKnockback").isToggled()) {
                            ...
                            NetHandlerPlayClient.this.gameController.displayGuiScreen(new GuiYesNo(new GuiYesNoCallback(){
                                ...
                                public void confirmClicked(boolean result, int id) {
                                    ...
                                    if (result) {
                                        ...
                                        Futures.addCallback((this).NetHandlerPlayClient.this.gameController.getResourcePackRepository().downloadResourcePack(s, s1), (FutureCallback)NetHandlerPlayClient.this.createDownloadCallback());
                                    } else {
                                        if (serverdata1 != null) {
