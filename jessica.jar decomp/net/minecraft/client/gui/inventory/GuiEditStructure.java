...
extends GuiScreen {
    ...
    private static boolean isValidCharacterForName(char p_190301_0_, int p_190301_1_) {
        boolean flag = true;
        Object[] objectArray = LEGAL_KEY_CODES;
        int n = LEGAL_KEY_CODES.length;
        int n2 = 0;
        while (n2 < n) {
        ...
        objectArray = ChatAllowedCharacters.ILLEGAL_STRUCTURE_CHARACTERS;
        n = ChatAllowedCharacters.ILLEGAL_STRUCTURE_CHARACTERS.length;
        n2 = 0;
        while (n2 < n) {
            int c0 = objectArray[n2];
            if (c0 == p_190301_0_) {
                flag = false;
                break;
            }
