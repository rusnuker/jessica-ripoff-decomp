...
extends GuiScreen {
    ...
    private void calcSaveDirName() {
        ...
        char[] cArray = ChatAllowedCharacters.ILLEGAL_FILE_CHARACTERS;
        int n = ChatAllowedCharacters.ILLEGAL_FILE_CHARACTERS.length;
        int n2 = 0;
        while (n2 < n) {
            char c0 = cArray[n2];
    ...
    public static String getUncollidingSaveDirName(ISaveFormat saveLoader, String name) {
        ...
        String[] stringArray = DISALLOWED_FILENAMES;
        int n = DISALLOWED_FILENAMES.length;
        int n2 = 0;
        while (n2 < n) {
