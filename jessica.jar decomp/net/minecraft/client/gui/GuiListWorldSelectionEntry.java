...
implements GuiListExtended.IGuiListEntry {
    ...
    public void func_192634_a(int p_192634_1_, int p_192634_2_, int p_192634_3_, int p_192634_4_, int p_192634_5_, int p_192634_6_, int p_192634_7_, boolean p_192634_8_, float p_192634_9_) {
        ...
        if (this.worldSummary.requiresConversion()) {
            ...
            s2 = this.worldSummary.markVersionInList() ? (this.worldSummary.askToOpenWorld() ? String.valueOf(s2) + ", " + I18n.format("selectWorld.version", new Object[0]) + " " + (Object)((Object)TextFormatting.RED) + s3 + (Object)((Object)TextFormatting.RESET) : String.valueOf(s2) + ", " + I18n.format("selectWorld.version", new Object[0]) + " " + (Object)((Object)TextFormatting.ITALIC) + s3 + (Object)((Object)TextFormatting.RESET)) : String.valueOf(s2) + ", " + I18n.format("selectWorld.version", new Object[0]) + " " + s3;
        }
