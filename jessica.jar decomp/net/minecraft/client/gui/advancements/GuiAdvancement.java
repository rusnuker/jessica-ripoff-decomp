...
extends Gui {
    ...
    private List<String> func_192995_a(String p_192995_1_, int p_192995_2_) {
        ...
        int i = this.field_191833_k.fontRendererObj.getStringWidth(String.valueOf(s) + ' ' + s1.split(" ")[0]);
        if (i - p_192995_2_ <= 10) {
    ...
    public void func_191821_a(int p_191821_1_, int p_191821_2_, float p_191821_3_, int p_191821_4_, int p_191821_5_) {
        ...
        if (flag1) {
            int k1 = 0;
            while (k1 < this.field_192997_l.size()) {
            ...
            int l1 = 0;
            while (l1 < this.field_192997_l.size()) {
