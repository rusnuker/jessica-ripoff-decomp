...
extends Gui {
    ...
    public static GuiAdvancementTab func_193936_a(Minecraft p_193936_0_, GuiScreenAdvancements p_193936_1_, int p_193936_2_, Advancement p_193936_3_) {
        ...
        AdvancementTabType[] advancementTabTypeArray = AdvancementTabType.values();
        int n = advancementTabTypeArray.length;
        int n2 = 0;
        while (n2 < n) {
            AdvancementTabType advancementtabtype = advancementTabTypeArray[n2];
