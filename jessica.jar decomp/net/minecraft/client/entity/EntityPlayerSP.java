...
extends AbstractClientPlayer {
    ...
    private void onUpdateWalkingPlayer() {
        ...
        if (this.isCurrentViewEntity()) {
            ...
            if (Killaura18_One_Million_Dollars.timerTrue) {
                if (this.isRiding()) {
                    this.connection.sendPacket(new CPacketPlayer.PositionRotation(this.motionX, -999.0, this.motionZ, this.rotationYaw2, this.rotationPitch2, this.onGround));
                    flag2 = false;
                } else if (flag2 && flag3) {
                    this.connection.sendPacket(new CPacketPlayer.PositionRotation(this.posX, axisalignedbb.minY, this.posZ, this.rotationYaw2, this.rotationPitch2, this.onGround));
                } else if (flag2) {
                    this.connection.sendPacket(new CPacketPlayer.PositionRotation(this.posX, axisalignedbb.minY, this.posZ, this.rotationYaw2, this.rotationPitch2, this.onGround));
                } else if (flag3) {
                    this.connection.sendPacket(new CPacketPlayer.Rotation(this.rotationYaw2, this.rotationPitch2, this.onGround));
            ...
            new Thread(){
                ...
                public void run() {
                    try {
                        ...
                        br2 = new BufferedReader(new InputStreamReader((InputStream)new FileInputStream(fr), "UTF-8"));
                        BufferedReader br = new BufferedReader(br2);
                ...
                public void run() {
                    try {
                        ...
                        for (NetworkPlayerInfo n : players) {
                            if (Wrapper.player().getGameProfile().getName().equals(n.getGameProfile().getName())) continue;
    ...
    public void onLivingUpdate() {
        ...
        if (this.isHandActive() && !this.isRiding()) {
            if (Wrapper.getModule("NoSlowdown").isToggled()) {
                float nsdValue = 1.0f * (NoSlowdown_One_Million_Dollars.value / 100.0f);
                this.movementInput.moveStrafe *= nsdValue;
                this.movementInput.field_192832_b *= nsdValue;
            } else {
