        ...
        while (j <= structureboundingbox.maxZ) {
            ...
            while (k <= structureboundingbox.maxY) {
                ...
                while (l <= structureboundingbox.maxX) {
                    Iterator blockpos4 = new BlockPos(l, k, j);
                    ...
                    if (!(flag1 && iblockstate.getBlock() == Blocks.AIR || block != null && (iblockstate.getBlock() != block || predicate != null && !predicate.apply((Object)iblockstate)))) {
