        ...
        if (this.hasFocus()) {
            ...
            if (key == 203) {
                ...
                if (this.cursorPos > 0 && this.value.length() > 0) {
                    this.value = this.cursorPos < this.value.length() ? String.valueOf(this.value.substring(0, this.cursorPos - 1)) + this.value.substring(this.cursorPos) : this.value.substring(0, this.cursorPos - 1);
                    --this.cursorPos;
                }
                if (this.consume) {
                    this.container.getInput().consumeEvent();
                ...
                this.value = this.cursorPos < this.value.length() ? String.valueOf(this.value.substring(0, this.cursorPos)) + c + this.value.substring(this.cursorPos) : String.valueOf(this.value.substring(0, this.cursorPos)) + c;
                ++this.cursorPos;
                if (this.consume) {
                    this.container.getInput().consumeEvent();
                }
