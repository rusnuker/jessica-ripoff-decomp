...
public class GuiSpoofUUID_Nirvana
extends GuiScreen {
    ...
    public GuiSpoofUUID_Nirvana(GuiScreen parentScreen2) {
    ...
    public void drawScreen(int i, int j, float f) {
        ...
        this.drawCenteredString(this.fontRendererObj, "\u2191 UUID, \u2193 IP.", this.width / 2, this.height / 4 - 60 + 20, 0xFFFFFF);
